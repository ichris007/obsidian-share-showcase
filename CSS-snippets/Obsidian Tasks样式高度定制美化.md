...
- 2026.7.6 修正了在个别情况下复选框和任务描述文字错位的问题。
...
.block-language-tasks {
  ...
  .suggestion-container .suggestion {
    ...
    font-size: 1rem; /* 图标尺寸 */
    line-height: 1.5rem !important;/* 设置行高,影响任务列表高度 */
...
.tasks-group-heading {
  ...
  /* 新增：调整文字颜色 */
  color: var(--text-muted) !important; /* 使用主题默认的弱化文字颜色 */
  opacity: 0.3; /* 60% 的不透明度，看起来会非常淡 */
  font-weight: 300 !important; /* 可选：稍微减小字重，让视觉感更轻盈 */
  font-size: 0.85em; /* 可选：稍微缩小一点标题字号，进一步瘦身 */
}
...
span.task-priority {
  ...
  .plugin-tasks-list-item {
    ...
    position: relative !important; /* 确保复选框的绝对定位相对于此容器 */
   ...
   .plugin-tasks-list-item:hover {
     border-bottom-color: var(--interactive-accent);/*边框文字色 var(--text-muted) 或互动色 var(--interactive-accent)*/
   }
    
    /*复选框定位 - 修复版本 */
    .task-list-item-checkbox {
      position: absolute !important;
      left: 4px !important;  /* 指定左偏移，使复选框对齐 */
      top: 50% !important;
      transform: translateY(-50%) scale(0.85) !important; /* 保持原有的缩放比例，同时垂直居中 */
    }
    ...
    .tasks-list-text {
      ...
      .task-description:hover {
        ...
        line-height: 1.3 !important; /*调整悬停后的行间距*/
      }      
      ...
      .tooltip.pop-up {
        ...
        transform: translate(-0.4em, calc(-100% - var(--hr-thickness) - 1px - 1px)) !important;/*4em：让气泡向右偏移一段距离；calc(-100% - ...)：通过计算让气泡向上移动，使其正好出现在任务文字的上方。它减去了行高、边框厚度以及 5px 的额外间距，确保气泡不会挡住任务文字。*/
